...
| USB3300 Board | DE-10 2x20 GPIO | FPGA pin |
| ------------- | --------------- | -------- |
| RST           | GPIO[17]        | PIN_AF4  |
| CLK           | GPIO[19]        | PIN_AF6  |
| DIR           | GPIO[21]        | PIN_AF9  |
| NXT           | GPIO[23]        | PIN_AE7  |
| STP           | GPIO[25]        | PIN_AE11 |
| DATA0         | GPIO[10]        | PIN_AG1  |
| DATA1         | GPIO[12]        | PIN_AG3  |
| DATA2         | GPIO[14]        | PIN_AG6  |
| DATA3         | GPIO[16]        | PIN_AG8  |
| DATA4         | GPIO[18]        | PIN_AF5  |
| DATA5         | GPIO[20]        | PIN_AF8  |
| DATA6         | GPIO[22]        | PIN_AF10 |
| DATA7         | GPIO[24]        | PIN_AE9  |
